...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			['Port'],
			['MarioMaster',		    'mariomaster',		    'Port',	 'https://www.youtube.com/c/MarioMaster1997',	'0xFFD10616'],
			['Optimizacion'],
			['Ulizar zd',		    'papu',		    'Optimizacion',	 'https://www.youtube.com/channel/UCBb9nVNHChCl6Jm0Mn2iaQw',	'0xFF6B6BFF'],
